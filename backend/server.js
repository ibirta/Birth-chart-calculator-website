...
//       // Fetch the Rising Sign (Ascendant)
//       const risingSignPromise = new Promise((resolve) => {
//         swisseph.swe_houses(julday, 0, latitude, longitude, "P", (housesData) => {
//           resolve({
//             position: housesData.ascendant.toFixed(2),
//             sign: getZodiacSign(housesData.ascendant), 
//           });
//         });
//       });
